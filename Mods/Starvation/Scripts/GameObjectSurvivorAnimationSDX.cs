...
public class GameObjectSurvivorAnimationSDX : MonoBehaviour, IAvatarController
{
    ...
    private const string Sleep = "laying_idle";
    private const string WakeUp = "getting_up";
    private const string LayDown = "getDown";
    ...
    public GameObjectSurvivorAnimationSDX()
    {
        this.IsVisible = true;
    }
    ...
    public bool IsAnimationSleepPlaying()
    {
        // Debug.Log("Method: " + System.Reflection.MethodBase.GetCurrentMethod().Name);

        if (this.ModelTransform.GetComponent<Animation>()[Sleep] != null && this.ModelTransform.GetComponent<Animation>()[Sleep].enabled)
            return true;
        return false;
    }
    ...
    {
        // Debug.Log("Method: " + System.Reflection.MethodBase.GetCurrentMethod().Name);
        //Debug.Log("SURVIVOR StartAnimationSleep");
        if ((this.ModelTransform.GetComponent<Animation>()[Sleep] == null))
            return;
        this.ModelTransform.GetComponent<Animation>().Play(Sleep);
        sleeping = true;
    }

    public bool IsAnimationWakeUpPlaying()
    {
        // Debug.Log("Method: " + System.Reflection.MethodBase.GetCurrentMethod().Name);

        if (this.ModelTransform.GetComponent<Animation>()[WakeUp] != null && this.ModelTransform.GetComponent<Animation>()[WakeUp].enabled)
            return true;
        return false;
    }

    public void StartAnimationWakeUp()
    {
        // Debug.Log("Method: " + System.Reflection.MethodBase.GetCurrentMethod().Name);
        //Debug.Log("SURVIVOR StartAnimationWakeUp");
        if (IsAnimationSleepPlaying()) this.ModelTransform.GetComponent<Animation>().Stop();
        if ((this.ModelTransform.GetComponent<Animation>()[WakeUp] == null))
            return;
        this.ModelTransform.GetComponent<Animation>().Play(WakeUp);
        wakingUp = true;
    }

    public bool IsAnimationLayDownPlaying()
    {
        // Debug.Log("Method: " + System.Reflection.MethodBase.GetCurrentMethod().Name);

        if (this.ModelTransform.GetComponent<Animation>()[LayDown] != null && this.ModelTransform.GetComponent<Animation>()[LayDown].enabled)
            return true;
        return false;
    }

    public void StartAnimationLayDown()
    {
        // Debug.Log("Method: " + System.Reflection.MethodBase.GetCurrentMethod().Name);
        //Debug.Log("SURVIVOR StartAnimationLayDown");
        if ((this.ModelTransform.GetComponent<Animation>()[LayDown] == null))
            return;
        this.ModelTransform.GetComponent<Animation>().Play(LayDown);
        layingDown = true;
    }
    ...
    protected void Update()
    {
        ...
        if (!(this.ModelTransform.GetComponent<Animation>()[Attack1] == null) && this.ModelTransform.GetComponent<Animation>()[Attack1].enabled || !(this.ModelTransform.GetComponent<Animation>()[Attack2] == null) && this.ModelTransform.GetComponent<Animation>()[Attack2].enabled || (!(this.ModelTransform.GetComponent<Animation>()[Death] == null) && this.ModelTransform.GetComponent<Animation>()[Death].enabled || !(this.ModelTransform.GetComponent<Animation>()[Pain] == null) && this.ModelTransform.GetComponent<Animation>()[Pain].enabled) || this.entityAlive.IsDead())
            return;
        if ((this.entityAlive as EntitySurvivorMod).IsSleeping())
        {
            if (layingDown)
            {
                if (!IsAnimationLayDownPlaying())
                {
                    layingDown = false;
                    if (!IsAnimationSleepPlaying())
                        StartAnimationSleep();
                }
            }
            else if(!IsAnimationSleepPlaying() && !IsAnimationLayDownPlaying() && !sleeping) StartAnimationLayDown();
            return;
        }
        else
        {
            if (sleeping)
            {
                if (!wakingUp)
                {
                    if ((IsAnimationSleepPlaying() || sleeping) && !IsAnimationLayDownPlaying() && !IsAnimationWakeUpPlaying())
                    {
                        StartAnimationWakeUp();
                        return;
                    }
                }
                else
                {
                    if (IsAnimationWakeUpPlaying()) return;
                    else
                    {
                        wakingUp = false;
                        sleeping = false;
