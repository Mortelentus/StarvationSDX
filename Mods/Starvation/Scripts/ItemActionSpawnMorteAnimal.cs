...
public class ItemActionSpawnMorteAnimal : ItemAction
{
    ...
    public override void ExecuteAction(ItemActionData _actionData, bool _bReleased)
    {
        ...
        if (vector3.Equals((object)Vector3.zero))
            return;
        {
            CreateEntityData dataToSend = new CreateEntityData();
            dataToSend.SendData(vector3, entityToSpawn, _actionData.invData.itemValue.Clone(),
...
{
    public bool SendData(Vector3 vector3, string entityToSpawn, ItemValue holdingItemValue, int playerID, int UID)
    {
        try
        {
            ...
            _es.teamNumber = uid;
            Debug.Log("Going to send the package with " + entityToSpawn + " and UID = " + uid + " meta = " +
